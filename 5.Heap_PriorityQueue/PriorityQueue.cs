...
namespace DataStructure
{
    ...
    // 힙 자료구조는 2개의 자식을 가질수있는 이진 트리 자료구조이다.
     ...
     * C# 은 노드기반 데이터는 GC에 부담을 주기때문에 배열로 구현하는게 좋다.
     */
    ...
    public class PriorityQueue<TElement,TPriority>
    {
        ...
        //Heap에서 데이터 빼기 // 우선순위가 가장낮은 노드를 삭제
