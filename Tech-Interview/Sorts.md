...
>[1. 선형 정렬](#선형-정렬)
>>[1.1. 선택 정렬](#1.Selection-Sort)
>><br>[1.2. 삽입 정렬](#2.Insertion-Sort)
>><br>[1.3. 버블 정렬](#3.Bubble-Sort)

>[2. 분할정복 정렬](#분할정복-정렬)
>>[2.1. 힙 정렬](#1.Heap-Sort)
>><br>[2.2. 합병 정렬](#2.Merge-Sort)
>><br>[2.3. 퀵 정렬](#3.Quick-Sort)
...
<center>
<img src="./Images/SortsImages/selectionSort.gif"/>
</center>
...
<center>
<img src="./Images/SortsImages/insertionSort.gif"/>
</center>
...
<center>
<img src="./Images/SortsImages/bubbleSort.gif"/>
</center>
...
<center>
<img src="./Images/SortsImages/heapSort.gif"/>
</center>
...
실제 시간을 측정하면 **다른 분할정복 정렬들 보다 느리다**

그이유는 선형적인 데이터는 CPU 의 캐시에 데이터가 올라가서 
반복작업하는게 빠르지만

heap은 배열 기반이지만 힙 구조상 데이터를 뛰엄뛰엄 탐색하기때문에
...
정렬 방법 : 데이터를 2분할하여 정렬 후 합병

구현 방법 : 

> 1. 리스트의 길이가 0 또는 1이면 이미 정렬된 것으로 본다. 
><br> 2. 그렇지 않은 경우에는 정렬되지 않은 리스트를 절반으로 잘라 비슷한 크기의 두 부분 리스트로 나눈다.
><br> 3. 각 부분 리스트를 재귀적으로 합병 정렬을 이용해 정렬한다.
><br> 4. 두 부분 리스트를 다시 하나의 정렬된 리스트로 합병한다.


<center>
<img src="./Images/SortsImages/mergeSort.gif"/>
</center>
...
분할 하면서 메모리 공간을 추가로 사용하기 때문에 메모리가 부족하다면 불리하다.
...
<center>
<img src="./Images/SortsImages/quickSort.gif"/>
</center>
...
단 최악의 경우에 정렬시간이 오래걸릴수있다. (정렬이 거꾸로되어있을때가 최악이다.)
