...
## 목차
    ...
    [4. Enqueue 구현](#enqueue-구현-/-값-추가-함수)
    [5. IsFull 함수 구현 1](#배열의-공간이-다-찼는지-확인하는-방법-/-isfull-함수-구현-1)
    [6. Dequeue 구현](#Dequeue-구현-/-값삭제 )
    [7. IsFull 함수 구현 2](#배열의-공간이-다-찼는지-확인하는-방법-/-Isfull-함수-구현-2)
...
왼쪽 그림을 보면 값을 추가했을때 이인데 이를 코드로 적으면
